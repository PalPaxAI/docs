---
title: 'Tokenomics'
description: 'Overview of $PalPaxAI token supply, treasury, liquidity, and vesting.'
icon: 'coins'
---

ℹ️ For legal and risk disclosures regarding $PalPaxAI, [click here](./token-use-and-legal-disclaimer).

## Token Details

1,000,000,000 $PalPaxAI tokens.
