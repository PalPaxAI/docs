...
It behaves like a real merchant: it advertises payment requirements, verifies your payment, settles it, and fulfills the request. The only difference is economic: every token you send is refunded immediately and PalPaxAI covers the network fees. This gives you production‑like behavior with zero cost.

## At a glance

- **Live URL**: https://x402.PalPaxAI.network
- **Who it’s for**: Developers building or validating x402 clients
- **What happens**: You send a payment → the request is fulfilled → your tokens are refunded → fees are paid by PalPaxAI

## Why use it

- **Fast iteration**: Validate your x402 client integration without deploying your own merchant.
- **Zero cost**: All tokens are refunded and PalPaxAI pays on‑chain fees.
...
- TypeScript clients: [Axios](https://github.com/PalPaxAI-network/x402/tree/main/clients/typescript/axios) and [Fetch](https://github.com/PalPaxAI-network/x402/tree/main/clients/typescript/fetch)
- Python clients: [httpx](https://github.com/PalPaxAI-network/x402/tree/main/clients/python/httpx) and [requests](https://github.com/PalPaxAI-network/x402/tree/main/clients/python/requests)
