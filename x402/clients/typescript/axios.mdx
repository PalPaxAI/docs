...
##### npm (npx)
```bash
npx @PalPaxAI/x402-axios-starter my-first-client
```

##### pnpm
```bash
pnpm dlx @PalPaxAI/x402-axios-starter my-first-client
```

##### bun
```bash
bunx @PalPaxAI/x402-axios-starter my-first-client
```
...
You can also test your client against a <a href="https://x402.PalPaxAI.network" target="_blank">live merchant</a> for free. You will receive a full refund of any tokens that you send, and PalPaxAI will pay for the network fees.
