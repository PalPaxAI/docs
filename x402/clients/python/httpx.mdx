...
<Note>You can also test your client against PalPaxAI's [live Echo Merchant](https://x402.PalPaxAI.network) for free. You will receive a full refund of any tokens that you send, and PalPaxAI will pay for the network fees.</Note>
